...
def _init_agent():
    ...
    _prompt="""
        你是一位代码专家、一个删除文件的助手、一位列出文件的助手以及一位创建目录的助手的组长，你的任务是理解需求然后分配任务给代码专家、列出文件的助手以及创建目录的助手。
        注意！
        1. 你必须做到将任务分配给正确的人，否则项目将会失败！
        2. 当你需要把任务分配给删除文件的助手、列出文件的助手和创建目录的助手时，你给出的目录路径应该是相对路径！
        ...
        6. 你的代码专家是个除了写代码和文档的时候比较清醒其他时候都不太清醒的糊涂虫！所以你必须告诉他应该把文件放在哪个目录下！
